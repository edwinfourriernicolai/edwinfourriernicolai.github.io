...
importance: 1
category: Research
related_publications: Caselli_FourrierNicolai_Fracasso_Scicchitano_2024a, Caselli_FourrierNicolai_Fracasso_Scicchitano_2024b
---

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/robot-pic.jpg" title="Robot" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-center">
    <div class="col-sm-10 mt-3 mt-md-0">
        <a href="https://dashboard-technology-diffusion.streamlit.app">
            {% include figure.html path="assets/img/dashboard-technology-diffusion-preview.jpg" title="Webapp" class="img-fluid rounded z-depth-1" %}
        </a>
    </div>
</div>
